    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 space-y-3">
        <p className="text-sm text-blue-800 dark:text-blue-200">
          💡 <strong>GB per day</strong> is raw uncompressed log volume. Elastic meters enriched size (~1.66×) for
          Serverless ingest. Other vendors may bill ingest and indexed retention separately — see each platform’s
